...
5. Usa modelos de movilidad apropiados con parámetros realistas
6. Configura aplicaciones de tráfico (UdpEchoClient/Server o OnOffApplication)
7. Duración: 100-300 segundos
8. Incluye logging para debugging
9. Manejo de errores básico
10. Comentarios en español explicando cada sección
...
def main():
    ...
    # 5. Instalar stack de Internet
    # 6. Configurar protocolo de enrutamiento
    # 7. Asignar direcciones IP
    # 8. Configurar aplicaciones
    # 9. Configurar FlowMonitor
