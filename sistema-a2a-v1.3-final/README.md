# 🚀 Sistema A2A v1.3 - Agent-to-Agent para Simulaciones NS-3

## Sistema Multi-Agente para Tesis Doctoral en Redes MANET

[![Version](https://img.shields.io/badge/version-1.3-blue.svg)](https://github.com)
[![Python](https://img.shields.io/badge/python-3.8+-green.svg)](https://python.org)
[![NS-3](https://img.shields.io/badge/NS--3-3.x-orange.svg)](https://nsnam.org)
